...
namespace MatHelper.BLL.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task UpdateUserAsync(Guid userId, UpdateUserRequest request)
        {
            ...
            {
                if(string.IsNullOrEmpty(request.CurrentPassword) || !VerifyPassword(request.CurrentPassword, user.PasswordHash, user.PasswordSalt))
                {
                ...
                user.PasswordHash = HashPassword(request.NewPassword, user.PasswordSalt);
            }
